      ...
      <div className="header-one">
        <div className="container header-one-block">
          ...
          <ul className="ul-header-one">
            ...
            <li className="ul-header-one-li">|</li>
            <li className="ul-header-one-li">
              <Link className="ul-header-one-li-link" to={"/auth"}>
          ...
          <div className="header-two-block-menu">
            ...
            <div style={{ width: "83%" }}>
              <ul className="ul-header-two">
                ...
                <li className="ul-header-two-li">
                  <Link to={"/news"} className="ul-header-two-li-link">
                    Новости
                  </Link>
                </li>
                <li className="ul-header-two-li">
                  <Link to={"/info/2"} className="ul-header-two-li-link">
                    Контакты
                  </Link>
                </li>
                <li className="ul-header-two-li">
                  <Link to={"/info/3"} className="ul-header-two-li-link">
                    Документы
                  </Link>
                </li>
                <li className="ul-header-two-li">
                  <Link to={"/info"} className="ul-header-two-li-link">
                    Меню
                  </Link>
                </li>
              </ul>
