        ...
        <div class="container">
            <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
              ...
              <ul class="nav nav-pills">
                <li class="nav-item"><button class="nav-link active" onClick={() => {
          ...
          <div style={{width: '520px', margin: 'auto'}}>
            <div>
              {res?.map(data => {
                ...
                return (
                  <div style={{display: 'flex', border: '1px solid #ccc', borderRadius: '15px',  marginBottom: '15px', padding: '15px', flexDirection: "column"}}>
                    <p>id: {data.id}</p>
                    <p>Имя: {data.name}</p>
